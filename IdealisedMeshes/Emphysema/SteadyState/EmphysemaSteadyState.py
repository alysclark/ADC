...
fml.OutputAddFieldNoType(baseName + ".phi", dataFormat, dependentField,
                         iron.FieldVariableTypes.U, iron.FieldParameterSetTypes.VALUES)
fml.OutputWrite("EmphysemaSteadyState.xml")
fml.Finalise()

# Export results
fields = iron.Fields()
fields.CreateRegion(region)
fields.NodesExport("EmphysemaSteadyStateResults", "FORTRAN")
fields.ElementsExport("EmphysemaSteadyStateResults", "FORTRAN")
fields.Finalise()
