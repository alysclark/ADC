...
for inlet_node in inlet_node_array:
    boundaryConditions.SetNode(dependentField, iron.FieldVariableTypes.U, 1, 1, int(inlet_node), 1,
...
for outlet_node in outlet_node_array:
    boundaryConditions.SetNode(dependentField, iron.FieldVariableTypes.U, 1, 1, int(outlet_node), 1,
...
fml.OutputAddFieldNoType(baseName + ".phi", dataFormat, dependentField,
                         iron.FieldVariableTypes.U, iron.FieldParameterSetTypes.VALUES)
fml.OutputWrite("SevereEmphysemaSteadyState.xml")
fml.Finalise()

# Export results
fields = iron.Fields()
fields.CreateRegion(region)
fields.NodesExport("SevereEmphysemaSteadyStateResults", "FORTRAN")
fields.ElementsExport("SevereEmphysemaSteadyStateResults", "FORTRAN")
fields.Finalise()
